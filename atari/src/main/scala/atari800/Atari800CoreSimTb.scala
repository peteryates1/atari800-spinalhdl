...
object Atari800CoreSimTb extends App {
  ...
  compiled.doSim("Atari800_boot_test", seed = 42) { dut =>
    ...
    // PAL palette lookup (from GtiaPalette.scala) — only need entries that actually appear
    // Full 256-entry table; most map to black, populated entries for hue $9x (blue)
    val palR = Array.fill(256)(0)
    val palG = Array.fill(256)(0)
    val palB = Array.fill(256)(0)
    // Greyscale $0x
    for (i <- 0 to 15) { val v = i * 0x11; palR(i) = v; palG(i) = v; palB(i) = v }
    // Blue $9x (COLPF2/foreground region)
    palR(0x90)=0x00; palG(0x90)=0x1F; palB(0x90)=0x30
    palR(0x91)=0x00; palG(0x91)=0x30; palB(0x91)=0x41
    palR(0x92)=0x00; palG(0x92)=0x41; palB(0x92)=0x52
    palR(0x93)=0x00; palG(0x93)=0x52; palB(0x93)=0x63
    palR(0x94)=0x00; palG(0x94)=0x63; palB(0x94)=0x74
    palR(0x95)=0x05; palG(0x95)=0x74; palB(0x95)=0x85
    palR(0x96)=0x16; palG(0x96)=0x85; palB(0x96)=0x96
    palR(0x97)=0x27; palG(0x97)=0x96; palB(0x97)=0xA7
    palR(0x98)=0x38; palG(0x98)=0xA7; palB(0x98)=0xB8
    palR(0x99)=0x49; palG(0x99)=0xB8; palB(0x99)=0xC9
    palR(0x9A)=0x5A; palG(0x9A)=0xC9; palB(0x9A)=0xDA
    palR(0x9B)=0x6B; palG(0x9B)=0xDA; palB(0x9B)=0xEB
    palR(0x9C)=0x7C; palG(0x9C)=0xEB; palB(0x9C)=0xFC
    // Orange $2x (COLPF0)
    palR(0x24)=0x6B; palG(0x24)=0x28; palB(0x24)=0x00
    palR(0x28)=0xAD; palG(0x28)=0x6A; palB(0x28)=0x12
    // Green $4x (COLPF3)
    palR(0x44)=0x00; palG(0x44)=0x4C; palB(0x44)=0x00
    palR(0x46)=0x0A; palG(0x46)=0x6E; palB(0x46)=0x00
    ...
    def writePpm(frameNum: Int): Unit = {
      ...
      dir.mkdirs()
      val path = s"sim_workspace/Atari800_boot_test/frame_$frameNum.ppm"
    ...
    val totalCycles = 10000000   // ~176ms = ~11 PAL frames - fast boot with reduced SIO retries
