# Vivado synth + impl + bitstream — Wukong XC7A100T 1080p HDMI (Phase 0).
# Requires a project created by create_project.tcl.
...
puts "INFO: bitstream at ${impl_dir}/Atari800Wukong1080Top.bit"
