// ECP5 fit check top-level: Atari800JopTop without cartridge slot
// No physical cart slot on Colorlight modules — eliminates spurious clock domain.
...
module fit_check_top (
    ...
    // Cart slot not present on ECP5 modules — leave outputs unconnected
    // so yosys optimizes away the clock-to-cart_phi2 driver.
