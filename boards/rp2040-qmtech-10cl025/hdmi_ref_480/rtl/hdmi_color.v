...
module hdmi_color(
	...
	wire clk_vga;//25m (640x480 test — was 74.25m)
	wire clk_vgax5;//125m (5x — was 371.25m)

	// Reuse the proven atari_pll (25 MHz c1 / 125 MHz c2) instead of pll_hdmi.
	atari_pll pll_hdmi_inst(
		.areset(1'b0),
		.inclk0(clk),
		.c0(),
		.c1(clk_vga),
